...
using Hack.Fast.Extensions.Log;
using StackExchange.Redis;

namespace Hack.Fast.Extensions.Redis
{
    public static class StackExchangeRedisHelper
    {
        private static readonly string Coonstr = ConfigurationManager.AppSettings["RedisExchangeHosts"];
        ...
        {
            LogHelper.SafeLogMessage("重新连接：Endpoint failed: " + e.EndPoint + ", " + e.FailureType +
