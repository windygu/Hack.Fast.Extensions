...
using Hack.Fast.Extensions.Reflection;
using System.Data;
using System.Xml;
...
namespace Hack.Fast.Extensions.DAL
{
	...
	/// <code>
	/// //字符串可以直接转换为CPQuery(需要引用using Hack.Fast.Extensions.DAL命名空间)
	...
	/// <code>
	/// //字符串可以直接转换为AsQueryParameter(需要引用using Hack.Fast.Extensions.DAL命名空间)
	/// var query = "insert into TestTable(RowGuid, RowString) values(".AsCPQuery()
	///         + Guid.NewGuid() 
	///         + "," + "dddddddddd".AsQueryParameter() + ")";
	/// //执行命令
